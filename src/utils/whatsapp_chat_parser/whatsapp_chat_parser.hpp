...
private:
	bool parseRow(std::shared_ptr<QXlsx::Cell> cell_inbound,
	...
	QString
	addMessage(WhatsappMessage::Type type, const QString& text, const QDateTime& date_time, const QString& reply_uuid = "");
